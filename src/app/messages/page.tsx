...
const conversations = [
    ...
    messages: [
      {
        id: 1,
        sender: "sarah_j",
        content: "Hey! I saw your post about Bali",
        timestamp: "10:30 AM",
      },
      {
        id: 2,
        sender: "me",
        content: "Yes! It was incredible. The temples were breathtaking",
        timestamp: "10:32 AM",
      },
      {
        id: 3,
  ...
  },
  {
    ...
    messages: [
      {
        id: 1,
        sender: "mike_explorer",
        content: "Your itinerary for Japan looks perfect!",
        timestamp: "9:20 AM",
      },
      {
        id: 2,
        sender: "me",
        content: "Glad you liked it! Make sure to visit the bamboo forest",
        timestamp: "9:25 AM",
      },
      {
        id: 3,
  ...
  },
  {
    ...
    messages: [
      {
        id: 1,
        sender: "wanderlust_emma",
        content: "Hi! I loved your Paris recommendations",
        timestamp: "7:15 AM",
      },
      {
        id: 2,
        sender: "me",
        content: "Thank you! Did you visit the Louvre?",
        timestamp: "7:20 AM",
      },
      {
        id: 3,
        sender: "wanderlust_emma",
        content: "Planning my next trip to Europe",
        timestamp: "7:25 AM",
      },
    ],
  },
  ...
  useEffect(() => {
    if (withUser) {
      ...
      const existingConv = conversations.find(
        (conv) => conv.user.username === withUser
      );
      if (existingConv) {
        ...
        <div className="p-4 border-b flex-shrink-0">
          <div className="flex items-center gap-3 mb-4">
            <Button variant="ghost" size="icon" asChild>
              <Link href={`/profile/${user?.username || "alex_doe"}`}>
